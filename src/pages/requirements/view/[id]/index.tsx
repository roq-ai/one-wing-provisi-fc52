...
import { getRequirementById } from 'apiSdk/requirements';
import { RequirementInterface } from 'interfaces/requirement';
import { IterationListPage } from 'pages/iterations';

function RequirementViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('requirement', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/requirements/edit/${id}`} passHref legacyBehavior>
                    <Button
