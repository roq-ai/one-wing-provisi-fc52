...
import { getIterationById } from 'apiSdk/iterations';
import { IterationInterface } from 'interfaces/iteration';

function IterationViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('iteration', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/iterations/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                ...
                {hasAccess('requirement', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                  <FormListItem
                    label="Requirement"
                    text={
                      <Link as={NextLink} href={`/requirements/view/${data?.requirement?.id}`}>
