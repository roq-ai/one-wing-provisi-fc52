...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'project.create.create': { roles: ['client'], key: 'project', tenantPath: [], userPath: [] },
  'project.update.update': { roles: ['client'], key: 'project', tenantPath: [], userPath: [] },
  'design.submit.create': { roles: ['graphic-designer'], key: 'design', tenantPath: [], userPath: [] },
};

const ownerRoles: string[] = ['graphic-designer'];
const customerRoles: string[] = [];
const tenantRoles: string[] = ['client', 'graphic-designer'];
